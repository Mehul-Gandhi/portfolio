...
links: [{name: "GitHub", content: "https://github.com/Mehul-Gandhi/gametheory-cv"}, {name: "GamesCrafters Research Group", content: "http://gamescrafters.berkeley.edu/"}], date: "2023-12-19", images: ["/connect4/visualValueHistory.png", "/connect4/ttt.png", "/connect4/connect4.png"]},
{ name: "Kitten Info Management",
  class: "CalHacks Hack for Impact 2024", 
  description: "Develop a dashboard for The Dancing Cat, a nonprofit cat adoption center in San Jose. This application provides publicly viewable information such as total cats available, vaccination schedules, emergency fund requests, and medical case statuses, as well as insights into the impact of their community support efforts.",
  details: [],
  skills: ["Python", "React", "Flask"],
  links: [{name: "GitHub", content: "https://github.com/Mehul-Gandhi/dancingcat"}, {name: "Video", content: "https://www.youtube.com/watch?v=eF92_jedFlg&feature=youtu.be"}, {name: "Submission", content: "https://hackforimpact.hackerearth.com/challenges/hackathon/berkley-hacks/dashboard/e6deb49/submission/published/kitten-info-management/"}],
  date: "02-28-2024",
  images: ["cat/home.png", "cat/dashboard.png", "cat/dashboard2.png", "cat/medical.png"],
},
{name: "GradeView", class: "Research Project", description: "Developed a dashboard for UC Berkeley's CS10 and CS61C for students to view grades and a concept map that shows which concepts a student has mastered.",
  details: [], skills: ["Python", "JavaScript", "React", "Docker", "Redis", "Google Sheets"],
  links: [{name: "GitHub", content: "https://github.com/Connor-Bernard/gradeView"}], 
  date:  "2024-05-13",
  images: ["/gradeview/mygrades.png", "/gradeview/map.png", "/gradeview/buckets.png"]
},
